...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-between px-6 lg:px-12 bg-black relative overflow-hidden">
        ...
        >
          <div className="relative flex flex-col items-center">
            ...
            <motion.div
              ...
              className="mt-8 inline-block px-4 py-2 rounded-full bg-yathra-green/10 border border-yathra-green/20"
            >
              <span className="text-yathra-green text-sm font-medium">
